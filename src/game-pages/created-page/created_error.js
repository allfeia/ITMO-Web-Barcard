export const createdErrors = (
  shuffledSteps,
  correctSteps,
  cocktailIngredients,
  userAnswers,
) => {
  if (!shuffledSteps.length || !correctSteps.length)
    return { ingredientErrors: 0, orderErrors: 0, totalErrors: 0 };
  ...
  shuffledSteps.forEach((step) => {
    ...
    if (
      ...
      userAnswers[step.step_number] !== correctIngredient.name
    ) {
      ingredientErrors += 1;
    }
  });
