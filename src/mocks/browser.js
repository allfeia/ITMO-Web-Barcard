...
export const worker = setupWorker(...signInBarman, ...getCocktails, ...getFavouritesCocktails, ...getCocktailRecipe, ...meInfo, ...addFavouriteCocktail, ...removeFavouriteCocktail);
